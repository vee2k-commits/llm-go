...
const ARCHETYPES = {
  ...
  carnival: { hero: "marquee", footer: "colophon" },
...
const THEME_GENRES = {
  ...
  aurora:    "atmospheric",
  // editorial — premium magazine register
  editorial: "editorial",
  // new themes
  carnival:  "editorial",
  lumen:     "atmospheric",
...
const COPY = {
  specimen: {
    ...
    proofB: "14 navs · 8 footers · 4 hero polish",
  ...
  newsprint: {
    ...
    title: HERO_TITLE,
    lede: "Twenty themes. Twenty-one named page shapes. Fifty component archetypes — fourteen navs, eight footers, four hero polish patterns. A 57-gate slop test that gates every output before it ships. Hallmark is the rulebook the LLM never read.",
  ...
  garden: {
    ...
    title: HERO_TITLE,
    lede: "Twenty themes that disagree with each other on purpose. Pick one and the whole page changes — not the colours, the bones.",
    ctaLabel: "Plant it",
    ...
    salutation: "Grown, not generated.",
  ...
  sport: {
    ...
    cta: "GO",
    stat: "20",
    qualifier: "THEMES · FOUR GENRES DEEP.",
  ...
  studio: {
    eyebrow: "Studio · 2026",
    title: HERO_TITLE,
    lede: "We design and build distinctive products for ambitious teams. Hallmark is our typography opinion, codified — twenty themes, twenty-one shapes, no defaults.",
    ctaLabel: "Engage",
    ...
    salutation: "We refuse the default.",
  ...
  bloom: {
    ...
    proofA: "Warm-light canvas, one soft bloom",
    proofB: "Geist sans, one weight, plain English",
    proofC: "Single restrained accent — never gradient text",
    cta: "Try it now",
    stat: "1",
    ...
    attrib: "Bloom note",
    salutation: "Welcome,",
    letterBody: "A calm, warm-light theme for the considered product page — generous space, one soft bloom, plain confident type, a single restrained accent. Restraint of a different kind.",
    signoff: "— Bloom",
    captionA: "Bloom",
    captionB: "Warm light",
  },
  coral: {
    ...
    attrib: "Coral note",
    salutation: "Restraint, with warmth.",
  ...
  editorial: {
    ...
    cta: "Read the issue",
    stat: "23",
    qualifier: "magazine-grade. hairline-set.",
    mockStat: "23",
  ...
  lumen: {
    ...
    title: HERO_TITLE,
    lede: "a design skill that refuses the defaults every model was trained on. twenty themes, twenty-one page-shapes, and one slop test that gates every build before it ships.",
    ctaLabel: "install",
    proofLabel: "00 · SPEC",
    proofA: "21 page-shapes · 50 archetypes",
  ...
  hum: {
    ...
    quote: "Two briefs should feel like two studios, not one template.",
    attrib: "Hum",
    salutation: "Made, not generated.",
    letterBody: "Every model defaults to the same page. Hum is the warm end of the refusal — cream paper, three accents that take turns, one small mark that reacts when you click. Twenty themes in the catalog, each with its own bones.",
    signoff: "— Hum",
    captionA: "Today",
    captionB: "Kept warm",
  },
  cobalt: {
    ...
    proofLabel: "Spec",
    proofA: "Cool engineered paper — never pure white",
    proofB: "Space Grotesk · Inter · JetBrains Mono",
    proofC: "One cobalt signal · hairline borders · ⌘K",
    cta: "Read the docs",
    stat: "1",
    qualifier: "signal accent, used sparingly.",
    mockStat: "1",
    quote: "A dev tool should read like good infrastructure: calm, precise, fast.",
    attrib: "Cobalt note",
    salutation: "Built to ship.",
...
function swapArchetypes(theme) {
  ...
  const copy = COPY[theme] || COPY.specimen; // resilience: themes without a bespoke COPY fixture fall back to specimen's (visual theme still applies)
